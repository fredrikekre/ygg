...
$(eval $(call simple-install,node,NodeJS_20_jll,node))
$(eval $(call simple-install,npm,NodeJS_20_jll,node))
...
$(eval $(call simple-install,cmake,CMake_jll,cmake))
$(eval $(call simple-install,wget,wget_jll,wget))
